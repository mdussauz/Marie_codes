...
for i = 1:100
    MotorTraceShifted{i+1} = circshift(MotorTraceAdjusted,i*10,1); % so here we are doing 10 sample shifts
end 
...
title(['Unit', num2str(whatneuron),' - explained var: ', num2str(round(cFull(c(1)),2))]) 
legend('Real data','Model')
subplot(4,1,3)
whatneuron = c(2); 
plot(spikeTrace(1:20000, whatneuron),'k'); hold on; plot(fullV(1:20000, whatneuron),'r');
title(['Unit', num2str(whatneuron),' - explained var: ', num2str(round(cFull(c(2)),2))]) 
legend('Real data','Model')
subplot(4,1,4)
whatneuron = c(4); 
plot(spikeTrace(1:20000, whatneuron),'k'); hold on; plot(fullV(1:20000, whatneuron),'r');
title(['Unit', num2str(whatneuron),' - explained var: ', num2str(round(cFull(c(3)),2))]) 
legend('Real data','Model')
