function [myFR, myPSTH, myRaster] = MakePSTH_MD (Spiketimes, EventsToAlign, WindowStart, window, varargin)
...
myRaster = zeros(size(Spiketimes,1),numel(timeBins)); %trials x window
%myRaster = [];
