...
function [MyTraces,timestamps,PSTH,Raster] = ProcessHaltReplayTrialsMD(Replay, TrialInfo, SingleUnits, TTLs, varargin)
...
for x = 1:numel(allreplays) % for every unique replay stretch
    ...
    Replay.ReplayTraces = Replay.TemplateTraces; 
