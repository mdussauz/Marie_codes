function [AllCorrs,AllResiduals,AllControlCorrs,AllControlResiduals] = CompareTuningCurves_v2(TuningCurves,boot)
...
for i = 1:size(TuningCurves.ClosedLoopFull,3) % every unit
    ...
    thisUnitControlCurves = squeeze([TuningCurves.ClosedLoopHalf1(:,1,i,:,boot) ...
                                     TuningCurves.ClosedLoopHalf2(:,1,i,:,boot)]);                      
