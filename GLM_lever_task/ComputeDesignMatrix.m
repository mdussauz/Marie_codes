...
% SessionPath = 'Z:\mdussauz\Smellocator\Processed\Behavior\O3';%if on grid
...
switch WhichSession
    ...
    otherwise
        ...
        % regressor groups
        regGroups = {'Lever' 'Motor' 'Odor' 'Sniff'}; %group names, second row are individual regressor labels
        regGroups{2,1} = {'Lever'};
        regGroups{2,2} = {'Motor'};
        regGroups{2,3} = {'Odor1' 'Odor2' 'Odor3'};
        regGroups{2,4} = {'Sniff'};
end
