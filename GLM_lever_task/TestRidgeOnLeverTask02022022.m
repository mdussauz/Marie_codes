...
regLabels = {'Trial On/Off' 'Odor1 location' 'Odor2 location' 'Odor3 location' 'Lever velocity'};
...
regGroups = {'Trial On/Off' 'Odor1 location' 'Odor2 location' 'Odor3 location' 'Lever velocity'};
