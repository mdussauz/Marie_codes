function [] = PlotBehaviorPerturbations_MD(timestamps,Lever,Sniffs,Licks,Rewards,Trial,TZ,Perturbation,OdorBoxHeight)
if nargin<8
    OdorBoxHeight = 5;
end
...
if ~isempty(Sniffs)
    ...
    set(handles.respiration_plot,'XData',timestamps,'YData', 6.5+ 2*(Sniffs/max(Sniffs(~isinf(Sniffs)))));
end
