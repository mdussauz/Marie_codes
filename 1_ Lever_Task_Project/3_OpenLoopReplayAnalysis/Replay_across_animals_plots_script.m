...
for session = 1:length(SessionName)
    ...
    [Thismodulated_units,Thismodulation_score, ThisResidualsMean, ThisResidualsMedian, ThisResidualsCI95] = GetReplayModulatedUnits(SessionName {session}, whichunit);
