function [modulated_units,modulation_score, ResidualsMean, ResidualsMedian, ResidualsCI95] = GetReplayModulatedUnits_v2(SessionName, whichunit, whichARrep, whichPRrep)
%version 2 
...
% conparison that are superior to the residual of within condition are
% worth keeping 
