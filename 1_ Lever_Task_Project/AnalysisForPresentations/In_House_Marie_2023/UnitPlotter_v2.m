function [x, AlignedFRs, BinOffset, RawSpikeCounts] = UnitPlotter_v2(whichUnit, whichodor, whichTZ, AlignedSpikes, Events, TrialInfo, AlignTo, trialsdone, trialboxcolor)
