% The only difference is that I am bypassing the information about the
% ycoord to define each channel as being at a different depth
...
function [spikeTimes, spikeAmps, spikeDepths, spikeSites] = ksDriftmapMD(ksDir, localizedSpikesOnly)
