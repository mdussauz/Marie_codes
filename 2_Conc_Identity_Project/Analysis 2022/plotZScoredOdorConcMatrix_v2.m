function []= plotZScoredOdorConcMatrix_v2(smoothPSTH)
...
mu = squeeze(mean(firingRatesAverage(:,:,:,1:prestim),[2 3 4])); 
sigma = squeeze(std(firingRatesAverage(:,:,:,1:prestim),0,[2 3 4]));  
